    ...
    <div class="row">
        <div class="container panel panel-primary">
            <div class="row">
                    ...
                    <div class="">
                        <div class="card mb-3">
                            <div class="card-body bg-warning">
                                ...
                                @if ($points > 1)
                                    <p class="card-text"><b>{{ $points }} points</b></p>
                                @else
                                    <p class="card-text"><b>{{ $points }} point</b></p>
                                @endif
                            </div>
                        </div>
                        <div>
                ...
                <div class="col-sm-9">
                    <div class="card-group mb-3 commandes flex-column">
                        @if(sizeof($orders) < 1)
                            ...
                            <div class="card my-2">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        @foreach($order->items as $orderItem)
                                            <li class="list-group-item d-flex align-items-center">
                                                <span class="badge badge-primary badge-pill mr-4">
                                                    {{ $orderItem->quantity }}
                                                </span>
                                ...
                                <div class="card-footer text-muted">
                                    ...
                                    @empty($order->shipping_address)
                                        <a class="btn btn-dark" href="{{ route('order.show', $order) }}">Modifier</a>
                                        Veuillez terminer votre commande en complétant les informations manquantes
                                    @endif
                                </div>
                            </div>
                        @endforeach
