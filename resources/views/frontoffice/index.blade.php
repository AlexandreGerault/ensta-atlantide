    ...
    <div class="row carre carousel slide" id="diaporama">
        <div class="carousel-inner">
            <div class="carousel-item active">
		        <img src="{{ asset('images/diapo1.jpg') }}" alt="diapo1" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/diapo3.jpg') }}" alt="diapo1" class="d-block w-100">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('images/diapo2.jpg') }}" alt="diapo1" class="d-block w-100">
            </div>
        </div>
    </div>
    <div class="row carre">
