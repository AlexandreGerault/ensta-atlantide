...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('articles')->insert([
            ...
            [
                'title' => 'La Liste Enst\'Atlantide',
                'subtitle' => NULL,
                'image' => NULL,
                'content' => 'Avec la congrégation des saints poulpes, vous aurez accès aux banquets avec potion de vie à volonté, fruit du pécher, tournois des mers ou danse de la promise !\nPartez à la quête du poulpe perdu et votez Enst\'Atlantide',
                'priority' => 50,
                'published' => 1,
                'slug' => 'Découvrir La Liste',
